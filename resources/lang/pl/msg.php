...
return [
    ...
    "Sorry, the page you are looking for could not be found." => "Przepraszamy, strona której szukasz nie została znaleziona.",
    "Sorry, we are doing some maintenance. Please check back soon." => "Przepraszamy, trwają pracę nad stroną. Sprawdź ponownie później.",
    "Sorry, you are forbidden from accessing this page." => "Przepraszamy, nie masz dostępu do tej strony.",
    "Sorry, you are making too many requests to our servers." => "Przepraszamy, wykonujesz za dużo zapytań do naszych serwerów.",
    "Sorry, you are not authorized to access this page." => "Przepraszamy, nie jesteś uprawniony do dostępu do tej strony.",
    "Sorry, your session has expired. Please refresh and try again." => "Przepraszamy, sesja wygasła. Odśwież i spróbuj ponownie.",
    ...
    "Whoops!" => "Ups!",
    "Whoops, something went wrong on our servers." => "Ups! Coś poszło nie tak na naszych serwerach.",
	...
	'welcome to your saamp page'=>'Witamy w Twojej przestrzeni Saamp',
           'Artisans, Manufacturers, Industrialists' =>'Rzemieślnicy, producenci, przemysłowcy', 
            'Semi finished Products'=>'Półprodukty',
            'Findings'=>'Zapięcia',
            'Jewelry'=>'Biżuteria',
            'Electroplating'=>'Galwanika',
            'Industrial refining'=>'Rafinacja przemysłowa',
            'Laboratory'=>'Laboratorium',
            'Scrap Gold Buyers, Investors'=>'Kolekcjonerzy, Inwestorzy, Handlowcy',
            'Metal transfer'=>'Transfer metalu',
            'Trading'=>'Handlowy',
            'My Operations'=>'Moje operacje',
            'My Orders'=>'Moje zamówienia',
            'My Euros Account'=>'Moje konto w EUR',
            'My templates'=>'Moje templatee',
            'My Metal Account'=>'Moje konto metalowe',
           ...
           'Quantity'=>'Ilość',
           'State'=>'Stan',
           'Optional Labour'=>'Prace dodatkowe',
           'Value'=>'Wartość',
           'Product'=>'Produkt',
           ...
           'Add the Template'=>'Dodaj template',
           'Update the Template'=>'Zaktualizuj template',
           'New Template'=>'Nowy template',
           'Template details'=>'Szczegóły templateu',
           'Pieces'=>'Sztuki',
           'My saved refining templates'=>'Moje zapisane templatee rafinacji',  
           'My saved laboratory templates'=>'Moje zapisane szablony laboratoryjne',
           'Template name'=>'Nazwa template',
           'Service Type'=>'Typ usługi',
           'Nature of jobs'=>'Rodzaj usługi',
           'Nature'=>'Charakter',
           'Nature of products'=>'Charakter produktów',
           'Nature of the batch'=>'Charakter partii',
           'Template'=>'Template',  
           'in grams'=>'w gramach',
            ...
            'Date'=>'Data',
            'Metals'=>'Metale',
            'Add a new Template'=>'Dodaj nowy template',
            'Artisan'=>'Rzemieślnik',
            'Manufacturer'=>'Producent',
            'Industrial'=>'Przemysłowy',
            'Gold Scraps Buyer'=>'Skup złomu', 
            'Investor'=>'Inwestor',
            'Last name'=>'Nazwisko',
            'Username'=>'Użytkownik',
            ...
            'Sales office'=>'Agencja',         
            'Address'=>'Adres',  
            'Carrier'=>' Transport',  
            'Country'=>'Kraj',      
            'Pick up address'=>'Adres odbioru',
            'Delivery address'=>'Adres dostawy',
            'Buyback of precious metals'=>'Odkup metali szlachetnych', 
            'Buyback'=>'Odkupić',       
            'Claimed weight'=>'Waga zgłoszona',
            'Received Weight'=>'Waga otrzymana',
            'Weight after melting'=>'Waga po stopieniu', 
            'Content'=>'Zawartość',
            'Net value'=>'Wartość netto',
            'Require a deposit'=>'Zażądaj zaliczki', 
            ...
            'My saved buyback templates'=>'Moje zapisane schematy wykupu',      
            ...
            'Pick up of address'=>'Adres odbioru',     
            'Self-Delivery'=>'Dostawa-własna',           
            'To prepare in my presence'=>'Aby przygotować w mojej obecności',
            'Estimated weight after burning'=>'Szacunkowa waga po spaleniu',           
            'Valuation - Results'=>'Wycena - Wyniki', 
            'Estimation of the results of the service following my assay'=>'Oszacowanie wyników usługi po analizie',          
            'Service Cart'=>'Kosz Serwisowy',  
            'Sample'=>'Próba',  
            'Requested Work'=>'Wymagana praca', 
            'Melting in my presence'=>'Topienie w mojej obecności',
            'Estimate of the value according to my content in precious metals'=>'Oszacowanie wartości na podstawie podanej zawartości metali szlachetnych',
            'My Cart'=>'Mój koszyk',  
            ...
            'Optional labour price'=>'Koszt prac dodatkowych', 
            'Piece'=>'Sztuka',
            'Label'=>'Etykieta',   
            'Debit'=>'Obciążyć', 
            'Credit'=>'Kredyt',    
            ...
            'Menu'=>'Menu',                  
            'Period'=>'Kropka',              
            'Bank of metal'=>'Źródło metalu',          
            'Sequence number'=>'Kolejność numerów',
            'City'=>'Miasto',
            'Account'=>'Konto', 
            'Ranking'=>'Ranking',              
            'In'=>'W',     
            'Account number'=>'Numer konta',                    
            'Account num'=>'Numer konta',              
