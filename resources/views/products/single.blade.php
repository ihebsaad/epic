...
<h2> {{__('msg.Product Page')}} <button onclick="window.history.go(-1); return false;" style="border:none" class="btn-success btn-sm float-right"><i class="fas fa-arrow-left"></i> {{__('msg.Back')}}</button></h2> 
                        ...
                        <div class="col-lg-7 mb-4">
						 ...
						 <div class="card shadow mb-4">
								...
								<div class="row">
									...
									<?php $mesures= $product[0]['mesures'];
									 ...
									 <label style="width:120px" class=" pt-10"><b><?php   echo $product[0]['NAT_MESURE1'] ; ?></b></label>
                                      ...
                                      <select onchange="showmesure2();details();$('#infos').show('slow');"  id="mesure1" class="form-control ml-10" style="max-width:90px;"  >
  									   <?php
 									...
 									<?php if($product[0]['NAT_MESURE2']!=''){?>
                                      <select    id="mesure2" class="form-control ml-10" required style="max-width:90px;" onchange=" $('#infos').show('slow');details();" >
									  <option></option>
								...
								$complements= $product[0]['complements'];
                                    ...
                                    <select id="etat_id" class="form-control ml-10" placeholder="Etat"  style="width:120px;margin-left:80px" onchange="details()">
