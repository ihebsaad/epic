                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="h5 font-weight-bold text-gray-800 text-uppercase mb-0">';?>
                                              <a href="<?php echo route('catalog',['type'=>103,'famille1'=>$famille1->id]);?>"><?php echo $famille1->libelle; ?></a></div>
 									<?php   echo ' </div>
                                        <div class="col-auto">
                                           '.$famille1->id.' <!--<i class="fas fa-calendar fa-2x text-gray-300"></i>-->
                                        </div>
                                    </div>
                                </div>
                            </div>
