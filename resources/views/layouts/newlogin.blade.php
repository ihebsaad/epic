...
<head>
    ...
    <link href="{{ URL::asset('public/sbadmin/vendor/fontawesome-free/css/all.min.css')}}" rel="stylesheet" type="text/css">
    <link
...
<body class="" style="font-family:Nunito">
    ...
    <script src="{{ URL::asset('public/sbadmin/js/jquery.min.js"></script>
    <script src="{{ URL::asset('public/sbadmin/js/bootstrap.bundle.min.js"></script>
-->
