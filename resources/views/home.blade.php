                             ...
                             <div class="card shadow mb-4">
								...
								.metal{height:50px;padding-top:15px;margin-bottom:10px;color:white;max-width:100px;}
								 ...
								 if($poids[0]->solde_pd >= 0){$style4="color:#54ba1d";}else{$style4="color:#d03132";}   
								  ?>
									<div class="row pb-10"><div class="col-md-5 col-sm-5" style="max-width:200px;color:black;"> <img src="{{ URL::asset('public/img/gold.png')}}" />  </div><div class="col-md-5 col-sm-5 mt-10" style="max-width:120px;"><B style="color:black">{{__('msg.Gold')}}</B><br><b style="<?php  echo $style1;?>"><?php echo  $poids[0]->solde_au; ?> g</b></div></div>
									<div class="row pb-10"><div class="col-md-5 col-sm-5" style="max-width:200px;color:black;"> <img src="{{ URL::asset('public/img/silver.png')}}" /></div><div class="col-md-5 col-sm-5 mt-10" style="max-width:120px;"><B style="color:black"> {{__('msg.Silver')}}</B><br><b style="<?php  echo $style2;?>"><?php echo  $poids[0]->solde_ag; ?> g</b></div></div>
									<div class="row pb-10"><div class="col-md-5 col-sm-5" style="max-width:200px;color:black;"> <img src="{{ URL::asset('public/img/platin.png')}}" /></div><div class="col-md-5 col-sm-5 mt-10" style="max-width:120px;"> <B style="color:black"> {{__('msg.Platinum')}}</B><br><b style="<?php  echo $style3;?>"><?php echo  $poids[0]->solde_pt; ?> g</b></div></div>
									<div class="row pb-10"><div class="col-md-5 col-sm-5" style="max-width:200px;color:black;"> <img src="{{ URL::asset('public/img/palla.png')}}" />  </div><div class="col-md-5 col-sm-5 mt-10" style="max-width:120px;"><B style="color:black"> {{__('msg.Palladium')}}</B><br><b style="<?php  echo $style4;?>"><?php echo  $poids[0]->solde_pd; ?> g</b></div></div>
								 <?php   ?>
                                </div>
                            </div>
